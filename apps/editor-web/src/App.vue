    ...
    <div v-if="!isMobile" class="left-panel" :style="{ width: `${leftWidth}px` }">
      <div class="panel-header">
        <div style="display: flex; flex-wrap: wrap; gap: 4px">
          ...
          <button
            @click="setExample(PARAGRAPH_DOC)"
            style="font-size: 10px; padding: 2px 4px; cursor: pointer"
          ...
          <button
            @click="setExample(ALIGNMENT_DOC)"
            style="font-size: 10px; padding: 2px 4px; cursor: pointer"
          ...
          <button
            @click="setExample(COLOR_GRADIENT_DOC)"
            style="font-size: 10px; padding: 2px 4px; cursor: pointer"
            title="Colors Only"
          >
            Colors
          ...
          <button
            @click="setExample(BASIC_STYLES_DOC)"
            style="font-size: 10px; padding: 2px 4px; cursor: pointer"
            title="Styles Only"
          >
            Styles
          ...
          <button
            @click="setExample(WORD_WRAP_DOC)"
            style="font-size: 10px; padding: 2px 4px; cursor: pointer"
            title="Wrap Only"
          >
            Wrap
          ...
          <button
            @click="setExample(INTERNATIONAL_DOC)"
            style="font-size: 10px; padding: 2px 4px; cursor: pointer"
